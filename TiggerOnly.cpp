...
TriggerOnly::TriggerOnly() {
    std::cout << "Creating an object of TriggerOnly State." << std::endl;
    std::cout << "*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*" << std::endl;
}

TriggerOnly::TriggerOnly(bool trigger_button_value, 
    ...
    std::cout << "*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*" << std::endl;
    std::cout << "Creating an object of TriggerOnly State using Custom Constructors." << std::endl;
}

TriggerOnly::~TriggerOnly() {
    exit();
    std::cout << "Removing an object of TriggerOnly State." << std::endl;
    std::cout << "*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*" << std::endl;
}

void TriggerOnly::enter() {
    std::cout << "Entering into the TriggerOnly State." << std::endl;
}

void TriggerOnly::execute() {
    std::cout << "Executing the TriggerOnly State." << std::endl;
...
void TriggerOnly::update(char button_type) {
    std::cout << "Updateing the value in TriggerOnly State." << std::endl;
    switch (button_type)
    {
        case 'T':
            ...
            break;
        case 'F':
            set_forward_button_value(1);
            break;
        case 'R':
            set_reverse_button_value(1);
            break;
        default:
...
void TriggerOnly::exit() {
    std::cout << "Exiting the TriggerOnly State." << std::endl;
}
